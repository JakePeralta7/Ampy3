"""Title and artist matching heuristics for Plex track resolution."""
...
def _best_match(search_title: str, candidates: list[dict], threshold: float = 0.75, search_artist: str | None = None) -> dict | None:
    ...
    if best_score >= threshold and best_match:
        logger.info(f"Matched '{search_title}' → '{best_match.get('title')}' score={best_score:.2f}")
        return best_match
